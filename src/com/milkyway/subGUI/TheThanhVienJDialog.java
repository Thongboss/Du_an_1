 ...
 */
public class TheThanhVienJDialog extends javax.swing.JDialog {
    ...
    public TheThanhVienJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thông tin thẻ thành viên");
        ...
        jLabel4.setText("Mã thẻ thành viên:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TheThanhVienJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TheThanhVienJDialog dialog = new TheThanhVienJDialog(new javax.swing.JFrame(), true);
